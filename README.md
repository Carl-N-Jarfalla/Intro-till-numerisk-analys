...
```python
x_värden = np.linspace(1, 2, num=100) # Ger hundera värden jämt fördelade mellan 1 och 2.
```
...
- [ ] Hur många rektanglar behöver du dela in området i för att få 4 korekta decimaler? (1.5707)